...
describe MagicSeven do
  ...
  describe '#subtract_random_number' do
    context 'when initializing with an explicit number' do
      it 'initializes correctly' do
        number = 10
        magic_seven = MagicSeven.new(number)
        expect(magic_seven.random_number).to eq(number)
      end
    end
  end
  ...
  describe '#play' do
    context 'when the random number is 1' do
      ...
      it 'will return 7' do
        number = 1
        magic_seven = MagicSeven.new(number)
        expect(magic_seven.play).to eq(7)
      end
    end

    context 'when the random number is 90' do
      # remove the 'x' before running this test
      it 'will return 7' do
        number = 90
        magic_seven = MagicSeven.new(number)
    ...
    context 'when the random number is 342524' do
      # remove the 'x' before running this test
      it 'will return 7' do
        number = 342_524
        magic_seven = MagicSeven.new(number)
