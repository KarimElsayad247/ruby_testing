...
# Long methods are like a run-on sentence that should have been divided into 2
# or 3 different sentences so that everything could be clearly understood and in
# this case if a method does many different things it can be difficult to test.
...
describe NumberGame do
  ...
  describe '#game_over?' do
    ...
    context 'when user guess is not correct' do
      ...
      subject(:game_not_over) { described_class.new(3, '6') }
  ...
  describe '#verify_input' do
    ...
    context 'when given invalid input as argument' do
      it 'returns nil' do
        bad_user_input = '10'
        verified_input = game_check.verify_input(bad_user_input)
  ...
  describe '#player_turn' do
    ...
    context 'when user inputs two incorrect values, then a valid input' do
      before do
        ...
        invalid_2 = '10'
        valid = '5'
        allow(game_loop).to receive(:player_input).and_return(invalid_1, invalid_2, valid)
      end
  ...
  describe '#final_message' do
    ...
    context 'when count is 4 and over' do
      ...
      # remove the 'x' before running this test
      it 'outputs correct phrase' do
        consolation_phrase = "That was hard. It took you 5 guesses!\n"
        expect { game_five.final_message }.to output(consolation_phrase).to_stdout
      end
    end
  end
end
